...
$System_Config['db_password'] = 'zhao@guo@hang.636261';						//用户名对应的密码
...
$System_Config['user_conn']='4';							//用户注册客户端数量限制，0为不限制
...
$System_Config['code_payback']='50';			//充值返利百分比
...
$System_Config['admin_contact1'] = 'QQ：1187531631';		//QQ、邮箱、微信仅用于举例
$System_Config['admin_contact2'] = '1187531631@qq.com';	//也可以写电话、tg等其他联系方式
$System_Config['admin_contact3'] = '1187531631';		//没有格式要求，想怎么写就怎么写，可留空
...
#iOS账户显示
$System_Config['display_ios_class']='2';	//至少等级为多少的用户可以看见，小于0时关闭此功能
$System_Config['display_ios_topup']='10';	//满足等级要求后，累计充值高于多少的用户可以看见
