...
/* Smarty version 3.1.34-dev-7, created on 2019-06-26 17:18:25
  from '/www/wwwroot/www.1024code.vip/resources/views/material/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d13386135be08_18739778',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cf74c7ba7dfbb802c2dd3b50494006f30a436784' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/user/index.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d13386135be08_18739778 (Smarty_Internal_Template $_smarty_tpl) {
											...
											<div class="tab-content">
												<div class="tab-pane fade <?php if ($_smarty_tpl->tpl_vars['ssr_prefer']->value) {?>active in<?php }?>" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														<p><span class="icon icon-lg text-white">filter_4</span> 备用导入节点方法：<?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>点击复制<?php }?><a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['ssr_url_all']->value;?>
"><i class="material-icons icon-sm">how_to_vote</i><?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>普通端口<?php } else { ?>点击复制<?php }?>链接</a><?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>或者<a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['ssr_url_all_mu']->value;?>
"><i class="material-icons icon-sm">how_to_vote</i>单端口多用户链接</a><?php }?>，然后右键小飞机->从剪贴板复制地址</p>
														<div><span class="icon icon-lg text-white">flash_auto</span> <?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>普通节点<?php }?>订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;
if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>?mu=0<?php }?>" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;
if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>?mu=0<?php }?>">点击复制</button><br></div>
														<?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>
														<div><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=1" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=1">点击复制</button><br></div>
														<?php }?>
...
?mu=1">点击复制</button><br></div>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													<p><span class="icon icon-lg text-white">filter_3</span >订阅成功后点击“完成”关闭界面，右击托盘纸飞机图标->服务器-><?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
->选择一个节点即可</p>
													<div><span class="icon icon-lg text-white">flash_auto</span> <?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>普通节点<?php }?>订阅地址：</div>
													<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;
...
">点击复制</button><br>
														...
														<?php } else { ?>
															<p class="card-heading" align="center"><b> 
																<i class="icon icon-lg">visibility_off</i>等级至少为<code><?php echo $_smarty_tpl->tpl_vars['display_ios_class']->value;?>
</code>且累计充值大于<code><?php echo $_smarty_tpl->tpl_vars['display_ios_topup']->value;?>
</code>时可见，如需升级请<a href="/user/shop">点击这里</a>升级套餐
															</b></p>
														<?php }?>
													<?php }?>
														...
														<p>或在 Safari 中点击<a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub0"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键<?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>普通端口<?php }?>订阅</a> <?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?><a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub1"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键单端口订阅</a><?php }?></p>
														...
														<div><span class="icon icon-lg text-white">flash_auto</span> <?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>普通节点<?php }?>订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" id="sub0" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;
if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>?mu=0<?php }?>" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;
if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>?mu=0<?php }?>">点击复制</button><br></div>
														<?php if ($_smarty_tpl->tpl_vars['mergeSub']->value != 'true') {?>
														<div><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" id="sub1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=1" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=1">点击复制</button><br></div>
													...
													<div class="tab-pane fade" id="all_ssr_android">
                                                      ...
                                                      <p><span class="icon icon-lg text-white">filter_5</span> 订阅出现系统自带的与<?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
，请把系统自带的无效订阅左滑删除（自带影响订阅更新速度）</p>
                                                      ...
                                                      <p><span class="icon icon-lg text-white">filter_7</span> 点击选择任意节点， 路由选择：略过区域网路以及中国大陆</p>
														...
														<p><span class="icon icon-lg text-white">filter_9</span> 备用导入节点方法：在手机上默认浏览器中点击<a href="<?php echo $_smarty_tpl->tpl_vars['ssr_url_all']->value;?>
" class="btn-dl"><i class="material-icons icon-sm">how_to_vote</i>普通端口链接</a>或者<a href="<?php echo $_smarty_tpl->tpl_vars['ssr_url_all_mu']->value;?>
" class="btn-dl"><i class="material-icons icon-sm">how_to_vote</i>单端口多用户链接</a>，然后点击确定</p>
...
?mu=1">点击复制</button><br></div>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_info">
														...
														<dl class="dl-horizontal">
                                                          <p><dt><code>优先导入普通端口，如果普通端口无法使用再导入单端口</code></dt></p>
															...
															<p><dt>自定义协议</dt>
															<dd><?php echo $_smarty_tpl->tpl_vars['user']->value->protocol;?>
</dd></p>
															<p><dt>自定义混淆</dt>
															<dd><?php echo $_smarty_tpl->tpl_vars['user']->value->obfs;?>
</dd></p>
															<p><dt>自定义混淆参数</dt>
															<dd><?php echo $_smarty_tpl->tpl_vars['user']->value->obfs_param;?>
</dd></p>
														</dl>
														<?php } else { ?>
												...
												<div class="tab-pane fade <?php if (!$_smarty_tpl->tpl_vars['ssr_prefer']->value) {?>active in<?php }?>" id="all_ss">
													...
													<div class="tab-pane fade active in" id="all_ss_windows">
														...
														<p><span class="icon icon-lg text-white">filter_3</span> 然后选择一个合适的服务器，代理规则选“绕过局域网和大陆”，然后即可上网</p>
														<p><span class="icon icon-lg text-white">filter_4</span> 备用导入节点方法：<a class="copy-text btn-dl" data-clipboard-text='<?php echo $_smarty_tpl->tpl_vars['ssd_url_all']->value;?>
'><i class="material-icons icon-sm">how_to_vote</i>点我复制链接</a>，然后右键小飞机->从剪贴板复制地址</p>
														<div><span class="icon icon-lg text-white">flash_auto</span> 节点订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=3" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=3">点击复制</button><br></div>
													</div>
													<div class="tab-pane fade" id="all_ss_mac">
														...
														<p><span class="icon icon-lg text-white">filter_2</span> <a class="copy-text btn-dl" data-clipboard-text='<?php echo $_smarty_tpl->tpl_vars['ss_url_all']->value;?>
'><i class="material-icons icon-sm">how_to_vote</i>点我复制链接</a>，然后右击托盘小飞机图标->从剪贴板导入服务器配置链接</p>
...
?mu=3">点击复制</button><br></div>
												...
												<div class="tab-pane fade" id="all_v2ray">
													...
													<div class="tab-pane fade active in" id="all_v2ray_windows">
														...
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=2" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=2">点击复制</button><br></div>
													</div>
													<div class="tab-pane fade" id="all_v2ray_ios">
														...
														<div><span class="icon icon-lg text-white">flash_auto</span> 节点订阅地址：</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" id="v2sub" readonly value="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=2" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subUrl']->value;
echo $_smarty_tpl->tpl_vars['ssr_sub_token']->value;?>
?mu=2">点击复制</button><br></div>
...
?mu=2">点击复制</button><br></div>
													...
													<div class="tab-pane fade" id="all_v2ray_info">
														...
														<p><a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['v2_url_all']->value;?>
"><i class="material-icons icon-sm">how_to_vote</i>点击这里复制全部 VMess 链接</a></p>
								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<dl class="dl-horizontal">
											...
											<dd><i class="icon icon-md">event</i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['user']->value->class_expire;?>
</dd>
                                              <?php } else { ?>
											...
											<p><dt>帐号过期时间</dt>
											  <dd><i class="icon icon-md">event</i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['user']->value->expire_in;?>
</dd>
                                            </p>
                                            <p><dt>账号有效期</dt>
                                              <i class="icon icon-md">event</i>
											...
											<dd><i class="icon icon-md">event</i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['user']->value->lastSsTime();?>
</dd>
                                              <?php } else { ?>
                                              <dd><i class="icon icon-md">event</i>&nbsp;从未使用</dd>
                                              <?php }?></p>
                                            <p><dt>上次签到时间：</dt>
                                            <dd><i class="icon icon-md">event</i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['user']->value->lastCheckInTime();?>
</dd></p>
								...
								<div class="card-main">
									<div class="card-inner">
										...
										<div class="progressbar">
	                                         ...
	                                         <div class="bar tuse color3" style="width:calc(<?php echo $_smarty_tpl->tpl_vars['user']->value->transfer_enable == 0 ? 0 : ($_smarty_tpl->tpl_vars['user']->value->u+$_smarty_tpl->tpl_vars['user']->value->d-$_smarty_tpl->tpl_vars['user']->value->last_day_t)/$_smarty_tpl->tpl_vars['user']->value->transfer_enable*100;?>
%);"><span></span></div>
											 <div class="label-flex">
												<div class="label la-top"><div class="bar ard color3"><span></span></div><span class="traffic-info">今日已用</span><code class="card-tag tag-red"><?php echo $_smarty_tpl->tpl_vars['user']->value->TodayusedTraffic();?>
</code></div>
											 </div>
										</div>
										<div class="progressbar">
										    <div class="before"></div>
										    <div class="bar ard color2" style="width:calc(<?php echo $_smarty_tpl->tpl_vars['user']->value->transfer_enable == 0 ? 0 : $_smarty_tpl->tpl_vars['user']->value->last_day_t/$_smarty_tpl->tpl_vars['user']->value->transfer_enable*100;?>
%);"><span></span></div>
										    <div class="label-flex">
										       <div class="label la-top"><div class="bar ard color2"><span></span></div><span class="traffic-info">过去已用</span><code class="card-tag tag-orange"><?php echo $_smarty_tpl->tpl_vars['user']->value->LastusedTraffic();?>
</code></div>
										    </div>
								        </div>
										<div class="progressbar">
											<div class="before"></div>
											<div class="bar remain color" style="width:calc(<?php echo $_smarty_tpl->tpl_vars['user']->value->transfer_enable == 0 ? 0 : ($_smarty_tpl->tpl_vars['user']->value->transfer_enable-($_smarty_tpl->tpl_vars['user']->value->u+$_smarty_tpl->tpl_vars['user']->value->d))/$_smarty_tpl->tpl_vars['user']->value->transfer_enable*100;?>
%);"><span></span></div>
											<div class="label-flex">
											   <div class="label la-top"><div class="bar ard color"><span></span></div><span class="traffic-info">剩余流量</span><code class="card-tag tag-green" id="remain"><?php echo $_smarty_tpl->tpl_vars['user']->value->unusedTraffic();?>
</code></div>
											</div>
									   </div>
