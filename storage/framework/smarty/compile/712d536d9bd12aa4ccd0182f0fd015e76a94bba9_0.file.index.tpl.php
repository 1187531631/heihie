<?php
/* Smarty version 3.1.34-dev-7, created on 2019-06-26 17:22:01
  from '/www/wwwroot/www.1024code.vip/resources/views/material/user/relay/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d1339394f5f28_34476601',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '712d536d9bd12aa4ccd0182f0fd015e76a94bba9' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/user/relay/index.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d1339394f5f28_34476601 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
echo $_smarty_tpl->tpl_vars['rule']->value->port;
														...
														<td><?php echo $_smarty_tpl->tpl_vars['rule']->value->priority;?>
                                                          ...
                                                          <td>
															<a class="btn btn-brand" <?php if ($_smarty_tpl->tpl_vars['rule']->value->user_id == 0) {?>disabled<?php } else { ?>href="/user/relay/<?php echo $_smarty_tpl->tpl_vars['rule']->value->id;?>
/edit"<?php }?>>编辑</a>
															<a class="btn btn-brand-accent" id="delete" value="<?php echo $_smarty_tpl->tpl_vars['rule']->value->id;?>
" <?php if ($_smarty_tpl->tpl_vars['rule']->value->user_id == 0) {?>disabled<?php } else { ?>href="javascript:void(0);" onClick="delete_modal_show('<?php echo $_smarty_tpl->tpl_vars['rule']->value->id;?>
')"<?php }?>>删除</a>
														</td>
												        </tr>
												    <?php
...
$(document).ready(function(){
	...
	<?php if (!$_smarty_tpl->tpl_vars['is_relay_able']->value) {?>
	$("#result").modal();
	$("#msg").html("为了中转的稳定，您需要在<a href='/user/edit'>资料编辑</a>处设置协议为以下协议之一： <br><?php
