<?php
/* Smarty version 3.1.34-dev-7, created on 2019-06-27 19:38:57
  from '/www/wwwroot/www.1024code.vip/resources/views/material/user/shop.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d14aad1a3e117_73841098',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c41d5a938c899b47096988844592a2f7c7896506' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/user/shop.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d14aad1a3e117_73841098 (Smarty_Internal_Template $_smarty_tpl) {
?>
					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								...
								<p>当前余额：<code><?php echo $_smarty_tpl->tpl_vars['user']->value->money;?>
</code> 元</p>
							</div>
						</div>
					</div>
...
<span> Mbps</span><?php }?>
								...
								<div class="shop-content">
									<div class="shop-content-left">账号有效期:</div><div class="shop-content-right"><?php echo $_smarty_tpl->tpl_vars['shop']->value->expire();?>
<span>天</span></div>
									<div class="shop-content-left">重置周期:</div><div class="shop-content-right"><?php ob_start();
...
<span>天</span><?php }?></div>
									<div class="shop-content-left">重置频率:</div><div class="shop-content-right"><?php ob_start();
echo $_smarty_tpl->tpl_vars['shop']->value->reset();
$_prefixVariable4 = ob_get_clean();
if ($_prefixVariable4 == '0') {?>N / A<?php } else {
echo $_smarty_tpl->tpl_vars['shop']->value->reset_value();?>
<span>G</span> / <?php echo $_smarty_tpl->tpl_vars['shop']->value->reset();?>
<span>天</span><?php }?></div>
								</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
								...
								<a class="btn btn-brand-accent shop-btn" href="javascript:void(0);" onClick="buy('<?php echo $_smarty_tpl->tpl_vars['shop']->value->id;?>
...
',<?php echo $_smarty_tpl->tpl_vars['shop']->value->auto_renew;?>
						...
						<div class="shop-drop dropdown-area">
							<div class="card-tag tag-black">账号有效期</div> <div class="card-tag tag-blue"><?php echo $_smarty_tpl->tpl_vars['shop']->value->expire();?>
 天</div>
							<?php ob_start();
echo $_smarty_tpl->tpl_vars['shop']->value->reset();
...
if ($_prefixVariable5 == '0') {?>
							...
							<?php } else { ?>
							<div class="card-tag tag-black">重置周期</div> <div class="card-tag tag-blue"><?php echo $_smarty_tpl->tpl_vars['shop']->value->reset_exp();?>
 天</div>
							<div class="card-tag tag-black">重置频率</div><div class="card-tag tag-blue"><?php echo $_smarty_tpl->tpl_vars['shop']->value->reset_value();?>
...
if ($_prefixVariable6 == '0') {?>
								...
								<?php } else { ?>
								<div class="card-tag tag-black">端口限速</div> <div class="card-tag tag-blue"><?php echo $_smarty_tpl->tpl_vars['shop']->value->speedlimit();?>
 Mbps</div>
								<?php }?>
								<?php ob_start();
echo $_smarty_tpl->tpl_vars['shop']->value->connector();
...
if ($_prefixVariable7 == '0') {?>
								...
								<?php } else { ?>
								<div class="card-tag tag-black">客户端限制</div> <div class="card-tag tag-blue"><?php echo $_smarty_tpl->tpl_vars['shop']->value->connector();?>
 个</div>
								<?php }?>
						</div>
					</div>
