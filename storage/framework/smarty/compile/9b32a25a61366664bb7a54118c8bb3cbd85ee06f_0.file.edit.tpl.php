<?php
/* Smarty version 3.1.34-dev-7, created on 2019-07-06 23:03:52
  from '/www/wwwroot/www.1024code.vip/resources/views/material/admin/shop/edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d20b85896f769_59016812',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9b32a25a61366664bb7a54118c8bb3cbd85ee06f' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/admin/shop/edit.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d20b85896f769_59016812 (Smarty_Internal_Template $_smarty_tpl) {
...
">
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="auto_renew" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->auto_renew;?>
">
						...
						<div class="card-main">
							<div class="card-inner">
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="bandwidth" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->bandwidth();?>
">
								</div>
						...
						<div class="card-main">
							<div class="card-inner">
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="expire" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->expire();?>
">
								</div>
							</div>
						</div>
						...
						<div class="card-main">
							<div class="card-inner">
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="class" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->user_class();?>
">
								</div>

								<div class="form-group form-group-label">
									<label class="floating-label" for="class_expire">等级有效期天数</label>
									<input class="form-control maxwidth-edit" id="class_expire" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->class_expire();?>
">
								</div>
							</div>
						</div>
						...
						<div class="card-main">
							<div class="card-inner">
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="reset_exp" type="number" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->reset_exp();?>
">
								</div>
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="reset" type="number" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->reset();?>
">
								</div>

								<div class="form-group form-group-label">
									<label class="floating-label" for="reset_value">重置流量为多少G</label>
									<input class="form-control maxwidth-edit" id="reset_value" type="number" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->reset_value();?>
">
								</div>
							</div>
						</div>
						...
						<div class="card-main">
							<div class="card-inner">
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="speedlimit" type="number" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->speedlimit();?>
">
								</div>
								...
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="connector" type="number" value="<?php echo $_smarty_tpl->tpl_vars['shop']->value->connector();?>
">
								</div>
							</div>
						</div>
						...
						<div class="card-main">
							<div class="card-inner">
								<div class="form-group form-group-label">
									...
									<input class="form-control maxwidth-edit" id="content_extra" type="text" value="<?php
