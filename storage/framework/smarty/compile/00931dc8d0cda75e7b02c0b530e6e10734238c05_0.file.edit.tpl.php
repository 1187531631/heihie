<?php
/* Smarty version 3.1.34-dev-7, created on 2019-06-26 22:08:25
  from '/www/wwwroot/www.1024code.vip/resources/views/material/admin/node/edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d137c593a2215_01822620',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00931dc8d0cda75e7b02c0b530e6e10734238c05' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/admin/node/edit.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d137c593a2215_01822620 (Smarty_Internal_Template $_smarty_tpl) {
?>
							...
							<div class="card-main">
								<div class="card-inner">
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="name" name="name" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->name;?>
">
									</div>
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="server" name="server" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->server;?>
">
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="node_ip" name="node_ip" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_ip;?>
">
									...
									<div class="form-group form-group-label" hidden="hidden">
										...
										<input class="form-control maxwidth-edit" id="method" name="method" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->method;?>
">
									</div>

									<div class="form-group form-group-label">
										<label class="floating-label" for="rate">流量比例</label>
										<input class="form-control maxwidth-edit" id="rate" name="rate" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->traffic_rate;?>
">
									</div>
							...
							<div class="card-main">
								<div class="card-inner">
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="status" name="status" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->status;?>
">
									</div>
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="info" name="info" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->info;?>
">
									</div>

									<div class="form-group form-group-label">
										<label class="floating-label" for="class">节点等级</label>
										<input class="form-control maxwidth-edit" id="class" name="class" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_class;?>
">
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="group" name="group" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_group;?>
">
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="node_bandwidth_limit" name="node_bandwidth_limit" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_bandwidth_limit/1024/1024/1024;?>
">
									...
									<div class="form-group form-group-label">
										...
										<input class="form-control maxwidth-edit" id="bandwidthlimit_resetday" name="bandwidthlimit_resetday" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->bandwidthlimit_resetday;?>
">
									</div>

									<div class="form-group form-group-label">
										<label class="floating-label" for="node_speedlimit">节点限速（Mbps）</label>
										<input class="form-control maxwidth-edit" id="node_speedlimit" name="node_speedlimit" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_speedlimit;?>
">
