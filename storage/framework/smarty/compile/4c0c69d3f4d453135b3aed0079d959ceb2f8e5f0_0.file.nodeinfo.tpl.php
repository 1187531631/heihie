<?php
/* Smarty version 3.1.34-dev-7, created on 2019-06-26 21:20:48
  from '/www/wwwroot/www.1024code.vip/resources/views/material/user/nodeinfo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d1371309c4ab0_60436199',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4c0c69d3f4d453135b3aed0079d959ceb2f8e5f0' => 
    array (
      0 => '/www/wwwroot/www.1024code.vip/resources/views/material/user/nodeinfo.tpl',
      1 => 1559631017,
      2 => 'file',
    ),
  ),
...
function content_5d1371309c4ab0_60436199 (Smarty_Internal_Template $_smarty_tpl) {
?>
										...
										<div class="tab-pane fade <?php if ($_smarty_tpl->tpl_vars['ssr_prefer']->value) {?>active in<?php }?>" id="ssr_url">
											<?php if (App\Utils\URL::SSRCanConnect($_smarty_tpl->tpl_vars['user']->value,$_smarty_tpl->tpl_vars['mu']->value)) {?>
												<?php if ($_smarty_tpl->tpl_vars['ssr_item']->value['obfs'] == "v2ray") {?>
													<p>您好，Shadowsocks V2Ray-Plugin 节点需要您的加密方式使用 AEAD 系列。请您到 资料编辑 页面修改后再来查看此处。</p>
												<?php } else { ?>
												<p><a class="copy-text" data-clipboard-text="<?php echo App\Utils\URL::getItemUrl($_smarty_tpl->tpl_vars['ssr_item']->value,0);?>
">点我复制配置链接</a></p>
												<p><a href="<?php echo App\Utils\URL::getItemUrl($_smarty_tpl->tpl_vars['ssr_item']->value,0);?>
">iOS 上用 Safari 打开点我即可直接添加</a></p>
												<?php }?>
											<?php } else { ?>
												<p>您好，您目前的 加密方式，混淆，或者协议设置在 ShadowsocksR 客户端下无法连接。请您选用 Shadowsocks 客户端来连接，或者到 资料编辑 页面修改后再来查看此处。</p>
											<?php }?>
										...
										<div class="tab-pane fade <?php if (!$_smarty_tpl->tpl_vars['ssr_prefer']->value) {?>active in<?php }?>" id="ss_url">
											<?php if (App\Utils\URL::SSCanConnect($_smarty_tpl->tpl_vars['user']->value,$_smarty_tpl->tpl_vars['mu']->value)) {?>
												<?php if ($_smarty_tpl->tpl_vars['ss_item']->value['obfs'] == "v2ray" && App\Utils\URL::CanMethodConnect($_smarty_tpl->tpl_vars['user']->value->method) != 2) {?>
													<p>您好，Shadowsocks V2Ray-Plugin 节点需要您的加密方式使用 AEAD 系列。请您到 资料编辑 页面修改后再来查看此处。</p>
												<?php } else { ?>
												<p><a class="copy-text" data-clipboard-text="<?php echo App\Utils\URL::getItemUrl($_smarty_tpl->tpl_vars['ss_item']->value,1);?>
">点我复制配置链接</a></p>
